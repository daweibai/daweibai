// v4: with instructions and will recruit participants
// by dawei 16/12/2020
let skip_instructions 	= true ;

const task_version    = 'v4_friends';

const n_each_direction = 10,
...
var instructions_1 = {
	...
	stimulus: 
		"<h1>Instructions</h1>" + 
		"<p>In this future-Nobel-Prize-winning experiment, your will see scenes of moving balls.</p>" + 
        ...
        "<img src= 'figures/figure scene1.jpg' style='width:500px'> "+
		"<p><strong>If you find the <img src= 'figures/T_ball.jpg' style='width:20px'>, press 'space' on your keyboard.</strong></p>"+
		"<p>We are interested in how fast you can find the <img src= 'figures/T_ball.jpg' style='width:20px'>, so please try to find it and respond as quickly as possible!</p>"+
